...
const MakeJourny = () => {
  const journeyData = [
    { id: "air-ticket", imageSrc: "/images/AirTicket.png", title: "Air Ticket" },
    { id: "tour-packages", imageSrc: "/images/TourPackages.png", title: "Tour Packages" },
    { id: "visa", imageSrc: "/images/Visa.png", title: "Visa" },
    { id: "customized-trip", imageSrc: "/images/CustomizedTrip.png", title: "Customized Trip" },
  ];
